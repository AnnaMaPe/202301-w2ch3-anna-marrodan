const info = [
  ...
  },
  {
    ...
    question: [
      ...
      "CON LA H. Lo que sale cuando se hace un fuego. ",
  ...
  },
  {
    ...
    question: [
      ...
      "CON LA I. Mineral de hierro de color negruzco, opaco, casi tan duro como el vidrio, cinco veces más pesado que el agua, y que tiene la propiedad de atraer el hierro, el acero y en grado menor algunos otros cuerpos.",
    ],
  },
  {
    letter: "j",
  ...
  },
  {
    ...
    question: [
      ...
      "CON LA K. Medida de peso que es igual que 1000 gramos.",
  ...
  },
  {
    ...
    question: [
      ...
      "CON LA M. Tela que se pone en las mesas a la hora de comer. ",
      "CON LA M. Escrito en que se hace pública declaración de doctrinas, propósitos o programas.",
    ],
  },
  {
    letter: "n",
  ...
  },
  {
    ...
    question: [
      ...
      "CONTIENE LA Ñ.  Representarse en la fantasía imágenes o sucesos mientras se duerme ",
    ],
  },
  {
    letter: "o",
    ...
    question: [
      ...
      "CON LA O. Preparar una cosa pensando detenidamente en todos los detalles necesarios para su buen desarrollo.",
  ...
  },
  {
    ...
    question: [
      ...
      "CONTIENE LA Q. Cometer delito.",
      "CON LA Q. Código de barras bidimensional que solo se puede leer con teléfonos u otros dispositivos inteligentes.",
    ],
  },
  {
    letter: "r",
    ...
    question: [
      ...
      "CON LA R. Desgastar la superficie de un alimento u otra cosa con los dientes o con un instrumento duro de manera que se vaya rebajando lentamente y a trozos pequeños.",
    ],
  },
  {
    letter: "s",
    ...
    question: [
      ...
      "CON LA S. Utensilio para sacar o afilar la punta a los lápices; está provisto de una cuchilla que afila la mina al tiempo que rebaja la madera. ",
    ],
  },
  {
    letter: "t",
    ...
    question: [
      ...
      "CON LA T. Utensilio para pinchar o recoger los alimentos sólidos y llevarlos a la boca que consiste en un mango con tres o cuatro púas iguales en uno de sus extremos.",
      "CON LA T. Tributo que se impone a la utilización de ciertos servicios, o al ejercicio de ciertas actividades.",
    ],
  },
  {
    letter: "u",
    ...
    question: [
      ...
      "CON LA U. Parte dura que está en la punta de los dedos, que cortamos cuando crece y se puede pintar. ",
    ],
  },
  {
    letter: "v",
    ...
    question: [
      ...
      "CON LA V.  Estación del año en la que hace mucho calor.",
  ...
  },
  {
    ...
    question: [
      ...
      "CONTIENE LA X. Avivar o aumentar un sentimiento o pasión, realzar el mérito o las cualidades de alguien.",
    ],
  },
  {
    letter: "y",
    ...
    question: [
      ...
      "CON LA Y. Mamífero équido, hembra, de tamaño mediano o grande, pelo corto de color generalmente uniforme y orejas cortas; se domestica con facilidad y suele usarse para la monta; hay muchas especies diferentes.",
    ],
  },
  {
    letter: "z",
    ...
    question: [
      ...
      "CON LA Z. Que usa con mayor habilidad las extremidades del lado izquierdo.",
      "CON LA Z. Planta que tiene una raíz comestible alargada de color anaranjado, y que les gusta mucho a los conejos.",
    ],
  },
];
...
const generalRandomScore = [-5, -2, 5];
let totalPoints = "";
const timer = 120;
let startTime = "";
let endTime = "";
...
const rules = () => {
  ...
  alert(
    `Game consists on guessing all the words in less than ${timer} seconds.` +
...
const randomScoreForEachPlayer = () => {
  const individualRandomScore =
    generalRandomScore[Math.floor(Math.random() * generalRandomScore.length)];
...
const ranking = () => {
  ...
  if (welcomeMessage !== "") {
    ...
    players.push({
      Name: "Stranger" + welcomeMessage.slice(1),
      Score: finalScore,
    });
  }
...
const startTimer = () => (startTime = new Date());

const endTimer = () => (endTime = new Date());
...
const playAgain = () => {
  const playAgainAnswer = Boolean(confirm("Would you like to play again?"));
  if (playAgainAnswer) {
    modifyToStartAgain();
...
const finalTime = () => {
  ...
  const timeLeft = timer - timeDifference;
  if (timeLeft > 0) {
    alert(
      `You have ${timeLeft} seconds left and your actual score is ${finalScore}.`
    );
    return true;
  }
...
const goodbye = () => {
  if (guessedQuestions.length !== 0) {
    alert(
      "You are leaving before finishing the game. You have guessed " +
        guessedQuestions.length +
        " words! Your final score is " +
        finalScore +
        " points." +
...
const generateQuestion = (turn) => {
  startTimer();
  turn.forEach((onlyQuestion) => {
    const randomQuestion = Math.floor(Math.random() * 3);
    const userAnswerRaw = prompt(onlyQuestion.question[randomQuestion]);
    const findIndex = info
      .map((element) => element.question[randomQuestion])
      .indexOf(onlyQuestion.question[randomQuestion]);
        ...
        const checkingAnswers = () => {
          if (info[findIndex].answer[randomQuestion] === userAnswer) {
            ...
            alert(
              "✅ Correct! ✅" +
                `\n ${capitalizeFirstLetter(
                  info[findIndex].answer[randomQuestion]
            ...
            if (info.length - guessedQuestions.length !== 0) {
              alert(
                "You have " +
                  (info.length - guessedQuestions.length) +
                  " words left to finish the game"
              );
    ...
    players.forEach((element) =>
      element.Score.push(randomScoreForEachPlayer())
    );
    endTimer();
    if (!finalTime()) {
      yourTimeIsOver();
